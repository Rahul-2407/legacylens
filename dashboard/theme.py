...
/* Belt-and-suspenders: force readable text color on markdown/expander
   body copy specifically, in case a component ships its own color that
   out-specifics the broad rule above (this is what caused low-contrast
   text on visitors whose browser prefers dark mode, before .streamlit/
   config.toml pinned the base theme to light). */
